...
**Пример 5. Назовите ошибку**
> «Раз молчание нельзя считать согласием, то никакие действия, прямо не выразившие волю словами, юридического значения не имеют».
- «Кто слишком много доказывает, тот ничего не доказывает» (qui nimium probat, nihil probat): из посылки следует заведомо ложное общее положение — обесценились бы любые конклюдентные (совершённые действием, а не словом) волеизъявления. Признак того, что доказано слишком много: годный на вид довод сметает и бесспорные случаи. Отличать от подмены понятия (когда посылка и вывод говорят о разных вещах): здесь довод формально об одном, но по силе захватывает лишнее.
