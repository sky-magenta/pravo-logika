...
Это **алетическая** модальность (возможность / действительность / необходимость). Отдельно стоит **нормативная (деонтическая)** модальность — обязательно / разрешено / запрещено; она разобрана в `deontic.md`.
